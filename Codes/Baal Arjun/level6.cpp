...
public:
	...
	void spawn(Enemy* enemy, int numEnemiesAlive, Vector2f resolution) override {
		...
		enemy[0].spawn(resolution.x / 2 + 200, resolution.y / 5 , 0, 1 , 100);
		enemy[1].spawn(resolution.x / 2 + 100, resolution.y / 5 * 2, 0, 1, 100);
		enemy[2].spawn(resolution.x / 2 + 100, resolution.y / 5 * 3, 0, 1, 100);
		enemy[3].spawn(resolution.x / 2 + 200, resolution.y / 5 * 4, 0, 1, 100);

		enemy[4].spawn(resolution.x / 2 + 400, resolution.y / 4 * 1, 1, 1, 200);
		enemy[5].spawn(resolution.x / 2 + 300, resolution.y / 4 * 2, 1, 1, 200);
		enemy[6].spawn(resolution.x / 2 + 400, resolution.y / 4 * 3, 1, 1, 200);

		enemy[7].spawn(resolution.x / 2 + 500, resolution.y / 2 , 2, 1, 150);
